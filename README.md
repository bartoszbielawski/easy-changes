...
- Polish names: every -is / -es / -s name, lowercase minors, moll/dur, Polish bass notes, English symbols that look Polish (Asus4) left alone, and B as B♭ only in Polish progressions
